...
export default class RegView extends JetView {
        ...
        ui={rows:[
            {
                ...
                template: 'http->templates/register.html'
            }]
        };
        return ui;
    ...
    drawForm(){
        var ui = {
                             view: "form",type: "clean", container:"formplacer",padding:40,
                             id: "reg_form",css:{border:"none !important;"},
                             elements: [
                                 { view: "text", placeholder: "Name", name: "name" },
                                 { view: "text", placeholder: "Email", name: "email" },
                                 { view: "text", type: "password", placeholder: "Password", name: "password" },
                                 { type: "clean", template: "Scan code:", height: 30 },
                                 { type: "clean", template: `<img class="qrcodeimg" id="qrcode"></img>`, height: 140, /*width: 135*/ },
                                 { type: "clean", template: "..and enter code from Google Authenticator:", height: 60 },
                                 { view: "text", placeholder: "Code", name: "secretcode",id:"secretcodef"},
                                 { view: "text", placeholder: "Recovery word", name: "key-word",},
                                 {
                                     margin: 5, cols: [
                                         { view: "button", value: "Register", type: "form",click:()=>{$$('reg_form').submit()} },
